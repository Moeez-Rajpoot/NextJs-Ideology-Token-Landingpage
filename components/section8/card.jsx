...
export default function card({ image, headtext, content }) {
  ...
  return (
    <div
      className=" w-[250px] h-[300px]   lg:w-[400px] lg:h-[430px] lg:-mt-32 rounded-lg overflow-hidden  hover:cursor-pointer"
    ...
    >
      ...
      >
        ...
        <h1
          className={`lg:text-2xl text-sm font-semibold ${spaceGrotesk.className} ${
