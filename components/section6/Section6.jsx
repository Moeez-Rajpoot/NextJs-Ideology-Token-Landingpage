...
export default function Section6() {
  return (
    <div className="h-fit lg:h-screen w-full bg-[#01091c] relative">
      ...
      <div className="grid grid-cols-2 filter-none  w-[80%] mx-auto h-[57%] z-10 relative">
        {/* Card 1 */}
        <div className="flex mt-14 ">
          <div id="image">
            <Image src={done} alt="Done" className="h-10 w-16"></Image>
          </div>
          <div id="section6content" className="ml-2">
            <h1
            ...
            <p
              className={`${poppins.className} text-sm mt-2 pr-10 text-[#7F9ED0]`}
            >
        ...
        <div className="flex  ">
          ...
          <div id="section6content" className="ml-1">
            <h1
              className={`${spaceGrotesk.className} text-[24px] -mt-2 font-semibold text-[#7F9ED0]`}
            >
              DeFi Access
      ...
      <button
        className={`mt-4 text-sm ${poppins.className} flex mx-auto mb-5 lg:mb-0  rounded-full bg-[#0b70bc] hover:bg-gradient-to-r from-[#0C71BC] to-[#0A25B1] text-white px-10 py-4 `}
      >
        Explore more
      </button>
    </div>
