...
export default function section2() {
  return (
    <div className="flex flex-col lg:flex-row h-fit lg:h-[70vh] w-full bg-[#090624] ">
      <div id="image" className=" w-full lg:w-[35%]">
        <Image
          src={halfmob}
          alt="Picture of the author"
          className="h-[65%] lg:h-[75%]  lg:mt-20 lg:ml-20"
        ></Image>
      </div>

      <div id="content" className=" w-full lg:w-[65%]">
        <div className=" w-screen mt-10 lg:mt-36 ml-8  h-fit  flex flex-col">
          ...
          <button
            className={`mt-11 w-[80%] lg:w-[12%] text-center text-sm ${poppins.className} mb-5 lg:mb-0  rounded-full bg-[#0b70bc] hover:bg-gradient-to-r from-[#0C71BC] to-[#0A25B1] text-white px-8 py-4 `}
          >
            Start Staking
          </button>
        </div>
