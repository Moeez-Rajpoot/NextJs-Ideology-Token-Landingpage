...
export default function Section() {
  return (
    <div className="h-fit lg:h-[70vh] w-full bg-[#01091c] relative ">
      <Image
        src={Vector}
      ...
      <Image
        src={MobFull}
        alt="Picture of the author"
        className="absolute h-[83%]  -top-14 lg:top-[72px] xl:top-[82px]  lg:right-28 lg:bottom-0"
      ></Image>

      <div
        id="workcontent"
        className={`${space_Grotesk.className}  h-full w-full lg:w-[50%] flex items-center`}
      >
